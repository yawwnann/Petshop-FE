        ...
        >
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <p className="text-gray-700 text-xl leading-relaxed mb-8 relative z-10">
              Buana Petshop didirikan atas dasar kepedulian dan rasa sayang yang
              mendalam terhadap hewan peliharaan. Setiap langkah yang kami ambil
              selalu dilandasi keinginan untuk memberikan yang terbaik bagi
              hewan, dari segi perawatan, kenyamanan, hingga kesejahteraan
              mereka.
            </p>
